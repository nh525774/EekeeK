  ...
  return (
        <ScreenWrapper bg="white">
                ...
                <div style={{...styles.loginContainer, gap: "28px", paddingTop: "32px", maxHeight: "calc(100vh - 100px)", overflowY: "auto"}}>
                    ...
                    <div>
                    <p style={{ fontWeight: theme.fonts.semibold }}>{user?.displayName || "User"}</p>
        ...
        {file && (
          <div style={{ position: "relative" }}>
            {getFileType(file) === "video" ? (
              <video src={getFileUrl(file)} controls style={{ width: "100%", borderRadius: "12px" }} />
            ) : (
              <img src={getFileUrl(file)} alt="preview" style={{ display: "block", margin: "0 auto", width: "100%", height: "auto",  maxWidth: "300px", objectFit: "contain", borderRadius: "12px" }} />
            )}
            <button
